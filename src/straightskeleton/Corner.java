...
// * Add a constructor from Tuple2d
...
{
	private static final long serialVersionUID = 2641272065486222118L;
...
//        { return false; }
    ...
    public static LoopL<Point3d> dupeNewAllPoints( LoopL<Point3d> ribbon )
    {
        ...
        {
            Loop<Point3d> loop = new Loop<Point3d>();
            loopl.add( loop );
            for ( Point3d c : pLoop )
                loop.append( cacheC.get(c) );
        }
