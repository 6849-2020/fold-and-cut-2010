...
public class DicerMk2
{
    ...
    Map<Double, RC> horiz = new LinkedHashMap<Double, RC>(), vert = new LinkedHashMap<Double, RC>();
    ...
    public DicerMk2( List<DRectangle> uiInput_ )
    {
        ...
        final double TOL = 5;
        List<Double> xes = new ArrayList<Double>(), yes = new ArrayList<Double>();

        List<DRectangle> rectangles = new ArrayList<DRectangle>();
        ...
        List<Double> hKeys = new ArrayList<Double>( horiz.keySet() ),
                vKeys = new ArrayList<Double>( vert.keySet() );
