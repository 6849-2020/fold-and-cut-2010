...
public class GraphMk1 <E>
{
    ...
    MultiMap<E,E> edges = new MultiMap<E,E>();
    ...
    {
        Set<Set<E>> out = new HashSet<Set<E>>();
        Set<E> toVisit = new HashSet<E>( nodes );

        while (!toVisit.isEmpty())
        {
            Set<E> adjacent = new HashSet<E>();
            Set<E> localToVisit = new HashSet<E>();
