...
public class Intersector 
{
    ...
    public List<Collision> intersectLines (List<Line> a)
    {
        ...
        while (events.size() > 0)
        {
            ...
            Set<Event> starts = new HashSet<Event>();
            Set<Event> ends = new HashSet<Event>();
            Set<Event> intersects = new HashSet<Event>();
...
//        }
        ...
        Set<Line> ending = new HashSet<Line>();
        for (Event e : ends)
            ending.add (e.a);
...
//        beachline.addAll( lines );
        ...
        Set<Line> processed = new HashSet<Line>();
        for (Event e : intersects)
        {
            processed.add(e.a);
            processed.add(e.b);
        ...
        else
        {
            ...
            List<Line> p = new ArrayList<Line>(processed);
            Collections.sort( p, new XOrderLineComparator() ); 

            Set<Line> horiz= new HashSet<Line>();
            for ( Line l : p )
                if ( l.isHoriz() )
                    horiz.add( l );
